		...
		<div className='Result'>
			<div
				...
				<div
					...
					<IoShareSocialSharp />
					<div
						className='result-social-networks-box'
						style={
							showShare
						...
						<WhatsappShareButton url={shareUrl} quote={shareQuote}>
							<WhatsappIcon size={36} style={SocialIconStyle} />
						</WhatsappShareButton>
						<TelegramShareButton url={shareUrl} quote={shareQuote}>
